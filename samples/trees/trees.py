...
TREES_WEIGHTS_PATH = os.path.join(ROOT_DIR, "/samples/trees/mask_rcnn_trees.h5")
...
class TreesDataset(utils.Dataset):
    ...
    def load_trees(self, dataset_dir, subset):
        ...
        self.add_class("trees", 1, "Canopy")
        self.add_class("trees", 2, "Trunk")
        self.add_class("trees", 3, "Root")
...
#         dataset_dir = os.path.join(dataset_dir, subset)
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "trees-coco-vgg.json")))
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = TreesDataset()
    dataset_train.load_trees(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = TreesDataset()
    dataset_val.load_trees(args.dataset, "val")
    dataset_val.prepare()
